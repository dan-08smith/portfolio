  ...
  return (
    <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        ...
        <p className="mt-6 text-lg text-gray-500 sm:text-xl max-w-xs sm:max-w-none mx-auto">
          Welcome to my landing page, where would you like to go?
        </p>


        <div className="mt-10">
          <Link href="https://d-smith.co.uk"
            className="rounded-md bg-blue-600 px-4 py-2 text-ml font-semibold text-white shadow hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >My Website</Link>
        </div>

        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center space-y-6 sm:space-x-8 sm:space-y-0">
